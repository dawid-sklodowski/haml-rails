...
Gem::Specification.new do |s|
  ...
  s.add_dependency "activesupport", "~> 4.0.beta"
  s.add_dependency "actionpack",    "~> 4.0.beta"
  s.add_dependency "railties",      "~> 4.0.beta"

  s.add_development_dependency "rails",   "~> 4.0.beta"
